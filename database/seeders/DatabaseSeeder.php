...
use App\Models\{
    Setting, Page, Community, Product,
    Album, AlbumPhoto, Post, Partner
};
...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $yungas = Community::updateOrCreate(['slug'=>'yungas'],[
            'name'=>'Yungas','province'=>'La Paz','description'=>'Comunidad apícola en Yungas.'
        ]);
        $valles = Community::updateOrCreate(['slug'=>'valles'],[
            'name'=>'Valles','province'=>'Cochabamba','description'=>'Comunidad de los valles.'
        ]);
